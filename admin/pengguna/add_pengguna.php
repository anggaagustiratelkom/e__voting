	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="nama_pengguna" name="nama_pengguna" placeholder="Nama Petugas" required>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="number" class="form-control" id="nohp" name="nohp" value="" placeholder="08xxxxxxxx" required/>
				</div>
			</div>
...
<?php
    ...
    //mulai proses simpan data
        $sql_simpan = "INSERT INTO tb_pengguna (npm,nama_pengguna,password,nohp,email,prodi,kelas,level,status,jenis) VALUES (
        '".$_POST['npm']."',
        '".$_POST['nama_pengguna']."',
        '".$_POST['password']."',
        '".$_POST['nohp']."',
