	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <textarea class="form-control" id="visi" name="visi" rows="3"><?php echo $data_cek['visi']; ?></textarea>
                </div>
             </div>
             ...
             <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <textarea class="form-control" id="misi" name="misi" rows="3"><?php echo $data_cek['misi']; ?></textarea>
                </div>
             </div>
